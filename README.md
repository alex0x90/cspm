...
├── research/
│   └── misconfigurations.md      # Detailed research on 9 S3 misconfigurations
└── tests/
    └── test_checks.py            # Unit tests with mocked Boto3 responses
```
...
| S3-002 | Bucket Encryption                | HIGH     | Missing default encryption; distinguishes SSE-S3 vs KMS  |
| S3-003 | Bucket Versioning                | MEDIUM   | Versioning not enabled; reports MFA Delete status        |
...
| S3-008 | Object Lock                      | MEDIUM   | WORM immutability protection not enabled                 |
| S3-009 | Account-Level Public Access Block| HIGH     | Account-wide public access block not enabled             |
  ...
  "misconfigurations": [
    {
      ...
      "issue": "Bucket 'my-bucket' has public access via: bucket policy.",
      "impact": "Publicly accessible S3 buckets can lead to unauthorized data access...",
      "remediation": [
...
The full S3 security research document with 9 misconfigurations, including attack scenarios, impact analysis, and step-by-step remediation, is available at:
